...
\subsubsection{Pathogenese und Zusammensetzung arterieller und venöser Thromben} % (fold)
...
\subsubsection{Medikamentöse Beeinflussung} % (fold)
...
\subsubsection{Acetylsalicylsäure(ASS)} % (fold)
...
\subsubsection{Thienopyridine} % (fold)
...
\subsubsection{GPIIb/IIIa(Integrin$\alpha$IIb$\beta$3)-Rezeptor-Antagonisten} % (fold)
...
\end{itemize}
\subsubsection{Vitamin-K-Reduktase-Hemmer (Cumarin-Derivate)} % (fold)
...
\subsubsection{Antithrombin-III-Aktivatoren} % (fold)
...
% paragraph wirkmechanismus (end)
\subsubsection{Streptokinase} % (fold)
...
\subsubsection{Gewebsplasminaktivator (rt-PA / Alteplase)} % (fold)
...
\subsubsection{Instabile Angina pectoris } % (fold)
