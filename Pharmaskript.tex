...
\usepackage{graphicx}
\usepackage{wrapfig}
\usepackage[table]{xcolor} %Für Zebrastripes
\usepackage{tikz}
\usepackage{gensymb}
\usepackage{wasysym}
...
\usepackage[total={19cm,27.7cm},top=1cm, left=1cm, includefoot]{geometry}

\definecolor{lightgray}{gray}{0.9} %Für Zebrastripes
...
\subsection{Superfamilie der humanen Cytochrom P450 Monooxygenasen} % (fold)
\label{sub:superfamilie_der_humanen_cytochrom_p450_monooxygenasen}

% subsection superfamilie_der_humanen_cytochrom_p450_monooxygenasen (end)

\begin{table}[h]
	\centering
	\rowcolors{1}{}{lightgray}
	\begin{tabularx}{\textwidth}{lp{1,9cm}p{3cm}Xp{1,8cm}X}
		\toprule \addlinespace
...
%siehe Abbildung~\ref{fig:Metabolite}
...
\begin{table}[h]
	...
	\centering
	\begin{longtable}{lp{3,2cm}lp{4cm}}
		\toprule
...
\begin{table}
	...
	\begin{longtable}{lllp{4cm}}
		...
		\bottomrule
	\end{longtable}
	\caption{Wichtige Rezeptortypen}
 	\label{tab:rezeptortypen}
\end{table}
...
\begin{figure}
	...
	\caption{Beispiel: Insulinrezeptor}
	\label{fig:insulinrezeptor}
\end{figure}
...
\begin{table}
	...
	\begin{longtable}{lll}
		...
		\bottomrule
	\end{longtable}
	\caption{Relevante Liganden und ihre nukleären Rezeptoren}
 	\label{tab:nukleaererezeptoren}
\end{table}
...
\begin{figure}
	...
	\end{equation}
	\caption{Pharmakon-Rezeptor-Interaktion: \textit{k$_1$}: Geschwindigkeitskonstante der Assoziation; \textit{k$_2$}: eschwindigkeitskonstante der Dissoziation im Äquilibrium gilt gemäß Massenwirkungsgesetz: \textit{K$_D$}: Äquilibrium-Dissoziations-Konstante Maß für die Affinität K$_D$ der meisten physiologischen Rezeptoren im Bereich von: 10$^{-9}$ - 10$^{-6}$ M}
\end{figure}
...
\subsection{Intrinsische Aktivität (Wirksamkeit, „efficacy“)}
Maß für die maximale Wirkung eines Pharmakons

\subsection{Konzentrations-Wirkungs-Beziehung:}
...
\begin{figure}
    \centering
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{Bilder/activity.png}
        \caption{Wirksamkeit und EC$_{50}$, Potenz}
        \label{fig:ligand1}
    \end{subfigure}
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
      %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{Bilder/Wirksamkeit.png}
        \caption{Wirksamkeit und Potenz}
        \label{fig:ligand2}
    \end{subfigure}
    \caption{Instrinsische Aktivität, EC$_50$, Potenz}
    \label{fig:liganden_enzyme}
\end{figure}

\subsubsection{Potenz}
Maß für die Konzentration einer Substanz, die zur Erreichung der halbmaximalen Wirkung notwendig ist.

\subsubsection{Wirksamkeit}
Maß für die maximal erreichbare Wirkung

\section{Agonismus}

\subsubsection{Agonist}
...
\begin{figure}
    \centering
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{Bilder/agonismus.png}
        \caption{Agonismus, Potenz und Wirksamkeit}
        \label{fig:agonimus}
    \end{subfigure}
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
      %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{Bilder/agonismus2.jpeg}
        \caption{Rezeptorzustände}
        \label{fig:rezeptorzustande}
    \end{subfigure}
    \caption{Agonismus}
    \label{fig:agonimusundpotenz}
\end{figure}

\section{Antagonismus}

\subsubsection{Antagonist}
Affinität zum Rezeptor, keine intrinsische Aktivität

\subsubsection{kompetitiver Antagonismus} 
...
\begin{figure}
    \centering
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{Bilder/antagonismus.png}
        \caption{Parallelverschiebung bei kompetitivem Antagonismus}
        \label{fig:agonimus}
    \end{subfigure}
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
      %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{Bilder/antagonismus2.png}
        \caption{Wirkungsreduktion durch nicht-kompetitiven Antagonismus}
        \label{fig:rezeptorzustande}
    \end{subfigure}
    \caption{Antagonismus}
    \label{fig:antagonimus}
\end{figure}
...
\subsubsection{pharmakokinetische Toleranz}
z.B. Metabolisation $\uparrow$ (Barbiturate, Äthanol)

\begin{figure}
	\centering
	\includegraphics[width=0.3\textwidth]{Bilder/toleranz}
	\caption{Pharmakolokinetische Toleranz}
	\label{fig:pharmakokinetischetoleranz}
\end{figure}	

\subsubsection{pharmakodynamische Toleranz}
...
\subsubsection{Hauptwirkung} 
therapeutisch erwünschte Wirkung

\subsubsection{Nebenwirkung} 
...
\begin{itemize}
	\item[2-5\%] in der Praxis 
	\item[6 - 20\%] in der Klinik
	\item[ca. 5\%] der Klinikaufnahmenerfolgen wegen unerw. Arzneimittelwirkungen
\end{itemize}

\glqq Alle Dinge sind Gift und nichts ist ohn’ Gift; allein die Dosis macht, daß ein Ding kein Gift ist.Paracelsus\grqq

\subsection{Unerwünschte Wirkungen im Rahmen des pharmakodynamischen Wirkprofils}
treten bei jedem Patienten dosisabhängig und spezifisch auf: \glqq Die Dosis macht das Gift\grqq

\begin{figure}[htb]
	\centering
	\includegraphics[width=0.3\textwidth]{Bilder/tbreite.png}
	\caption{Therapeutische Breite}
	\label{fig: therbreite}
\end{figure}
...
\subsubsection{Absolute Überdosierung} 
durch Verordnungs- oder Einnahmefehler

\subsubsection{Relative Überdosierung} 
...
\begin{table}
	\rowcolors{2}{lightgray}{white}
	\centering
	\begin{longtable}{p{4cm}ll}
		\toprule
		Pharmakokinetisch&&\\
		\midrule \addlinespace
		Resorption&&Effekte\\                                              \midrule                         
	...
	\bottomrule
	\end{longtable}
	\caption{Beispiele: unerwüschte Arzneimittelinteraktionen}
 	\label{tab:arzneimittelinteraktionen}
\end{table}
...
\subsubsection{Arzneimittelallergie}
...
\subsubsection{Pseudoallergische Reaktion}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.9\textwidth]{Bilder/cholinergessystem.png}
	\caption{Cholinerges System im Vergleich}
	\label{fig:cholinergessystem}
\end{figure}
...
\begin{table}[htb]
	...
	\begin{longtable}{lll}
		\toprule
		Eigenschaft&somatomotor. System&autonomes System\\
		\addlinespace
		\midrule
		...
		\bottomrule
	\end{longtable}
	\caption{Eigenschaften des somatomotorischen und autonomen Systems}
 	\label{tab:somatomotorischautonom}
\end{table}
...
\begin{figure}[htb]
    \centering
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{Bilder/ach.png}
        \caption{Acetylcholin}
        \label{fig:acetylcholin}
    \end{subfigure}
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
      %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{Bilder/achsynapse.png}
        \caption{Acetylcholin-Synapse}
        \label{fig:achsynapse}
    \end{subfigure}
    \caption{Acetylcholin-System}
    \label{fig:achsystem}
\end{figure}
...
\begin{figure}
    \centering
    \begin{subfigure}[b]{0.2\textwidth}
        \includegraphics[width=\textwidth]{Bilder/achesterase1.png}
        \caption{Motorische Endplatte}
        \label{fig:endplatte}
    \end{subfigure}
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
      %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[b]{0.2\textwidth}
        \includegraphics[width=\textwidth]{Bilder/achesterase2.png}
        \caption{ZNS}
        \label{fig:zns}
    \end{subfigure}
     ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
      %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[b]{0.2\textwidth}
        \includegraphics[width=\textwidth]{Bilder/achesterase3.png}
        \caption{sezernierte Form}
        \label{fig:sezernierte_form}
    \end{subfigure}
    \caption{Subtypen der Acetylcholinesterase}
    \label{fig:achesterase}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.2\textwidth]{Bilder/gprotein.png}
	\caption{muskarinischer G-Proteinrezeptor}
	\label{fig:mgpr}
\end{figure}
...
\begin{table}
	...
	\begin{longtable}{llll}
		...
		\bottomrule
	\end{longtable}
	\caption{Cholinerge Rezeptoren}
 	\label{tab:cholrezeptoren}
\end{table}

\subsubsection{nikotinisch}	

ionotrope Rezeptoren, Pentamere, 2 $\alpha$-Untereinheiten ($\alpha$2-10 3 $\beta$-Untereinheiten ($\beta$2-4) $\alpha$-Untereinheit bindet Ach Rezeptor bildet Na$^+$/K$^+$-Kanal, der d. Bindung von Ach geöffnet wird $\rightarrow$ Na$^+$-Einstrom $\rightarrow$ Depolarisation 

\begin{itemize}
	\item[N$_M$](muskulärer Typ)
	\begin{itemize}
		\item[($\alpha$1)$_2$,$\beta$1,$\delta$,$\epsilon$] (embryonal/denerv. Muskel:$\gamma$ statt $\epsilon$) neuromuskuläre Endplatte der Skelettmuskulatur, vermittelt Kontraktion	
	\end{itemize}
	
	\item[N$_N$](neuronaler Typ)
		\begin{itemize}
			\item[($\alpha$4)$_2$/($\beta$2)$_3$] häufig im ZNS, (v.a. K$^+$/Na$^+$ permeabel)
			\item[($\alpha$7)$_5$] häufig im ZNS, (auch Ca$^{2+}$ permeabel)
			\item[($\alpha$3)$_2$/($\beta$4)$_3$] Ganglion-Typ $\rightarrow$ Depolarisation/Weiterleitung; NN-Mark $\rightarrow$ Sekretion von Katecholaminen
		\end{itemize}
\end{itemize}

\begin{figure}[htb]
	\centering
	\includegraphics[width=0.3\textwidth]{Bilder/achrezeptor.png}
	\caption{Nikotinischer Acetylcholinrezeptor}
	\label{fig:achrezeptor}
\end{figure}

\subsection{Agonisten / Antagonisten des nikotinischen Ach-Rezeptor}

\subsubsection{Nikotin}(agonistische Wirkung v.a. auf neuronalen Rezeptor (N$_N$)
...
\subsubsection{Muskelrelaxantien}
(Wirkung v.a. auf muskulären Rezeptor ($N_M$))

\begin{figure}[htb]
	\centering
	\includegraphics[width=0.4\textwidth]{Bilder/motorischeendplatte.png}
	\caption{Motorische Endplatte}
	\label{fig:motorischeendplatte}
\end{figure}
...
\paragraph{Wirkung}
Motorische Lähmung, keine Bewusstseinsbeeinflussung äußere Augenmuskeln $\rightarrow$ Zunge $\rightarrow$ Finger $\rightarrow$ Nacken $\rightarrow$ Stamm $\rightarrow$ Extremitäten $\rightarrow$ Atemmuskulatur

\paragraph{Einsatz}
 V.a. Narkose

\paragraph{Pharmakokinetik}
Quarternären Stickstoff $\rightarrow$ schlechte Resorption nach oraler Gabe $\rightarrow$ keine ZNS-Gängigkeit

\subsection{nicht-depolarisierende Muskelrelaxantien}
Tubocurarin: Wirkdauer 60-80 min; zusätzliche Wirkungen: Histaminfreisetzung aus Mastzellen Ganglienblockade $\rightarrow$ RR$\downarrow$;  obsolet.
...
\begin{table}[htb]
	...
	\begin{longtable}{llll}
		\toprule
		Pharmakon&Potenz (im Vergl. zu Tubocurarin)&Wirkdauer&Wirkbeginn\\
		\addlinespace
		\midrule
		\addlinespace
		Benzylisochinoline&&&\\
		...
		\bottomrule
	\end{longtable}
	\caption{Nicht-depolarisierende Muskelrelaxantien}
 	\label{tab:nukleaererezeptoren}
\end{table}

\paragraph{Elimination}
spontan (Atracurium); unspez. Esterasen (Atracurium, Mivacurium) renal/hepatisch: Steroidderivate
...
\paragraph{Wirkung} 
Agonismus am Rezeptor, langsamer Abbau persistierende Depolarisation $\rightarrow$ Inaktiv. spannungsabh. Na$^+$-Kanälen $\rightarrow$ Sarcolemm elektrisch unerregbar; kein Antagonismus durch Ach-esterase-Hemmer! Wirkdauer 5-10 min, Abbau d. Esterspaltung (unspez. Cholinesterasen)

\paragraph{Einsatz}  
nur noch selten eingesetzt (kurzdauernde Eingriffe)

\paragraph{unerwünschte Wirkungen}
protrahierte Apnoe (hereditärer Cholinesterase-Mangel); Muskelkater-ähnliche Symptome; Hyperkaliämie;  maligne Hyperthermie

\section{Agonisten / Antagonisten muskarinischer Rezeptoren antimuskarinerge Substanzen / Parasympatholytika}
...
\begin{itemize}
	...
	\item M.-D.-Trakt: Speichelsekretion $\downarrow$ (Mundtrockenheit) (0,5 mg), Magensaftsekretion $\downarrow$ (1–2 mg), Motilität$\downarrow$, Darmatonie, Tonus von Darm, Gallenblase $\downarrow$
...
\subsection{M3-selektiv} 
\begin{tabularx}{\textwidth}{XX}
Solifenacin&Darifenacin\\
\end{tabularx}

\subsection{quarternäre Derivate}
...
\begin{table}
	...
	\begin{longtable}{lccc}
		\toprule
		&\multicolumn{2}{c}{Rezeptorspezifität}&\\
		\cmidrule{2-3}
		&muskarin.&nikotin.&Hydrolyse durch AchE/ChE\\
		\midrule
		Acetylcholin&+++&+++&+++\\
		Carbachol&+++&+++&-\\
		Bethanechol&+++&-&-\\
...
(je nach erwünschter Wirkung) Schweißausbruch; Speichelfluss; Übelkeit, Erbrechen, Diarrhoe; Bradykardie, Blutdruckabfall; asthmatische Beschwerden; Harndrang; Myopie
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.5\textwidth]{Bilder/achesterase}
	\caption{Zyklus der Acetylcholinesterase}
	\label{fig:achesterasezyklus}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.4\textwidth]{Bilder/achesterasehemmung.jpeg}
	\caption{Hemmung der Acetylcholinesterase}
	\label{fig:achesterasehemmung}
\end{figure}

\subsubsection{nicht-kovalent} % (fold)
\label{ssub:nicht_kovalent}
...
\subsubsection{kovalent (carbamylierend)} % (fold)
\label{ssub:kovalent_carbamylierend_}
...
\subsubsection{Kampfstoffe} % (fold)
\label{ssub:kampfstoffe}

\begin{itemize}
	\item Tabun, Sarin, Soman	extrem toxische „Nervengase“ Aufnahme in den Körper:  oral, inhalatorisch, transdermal!\\ 
	Vergiftungssymptome: 
	\begin{itemize}
...
\chapter{Anti-Parkinsonmittel} % (fold)
\label{cha:anti_parkinsonmittel}
\section{Dopaminerges System} % (fold)
\label{sec:dopaminerges_system}
\subsection{Dopaminerge Synapse} % (fold)
\label{sub:dopaminerge_synapse}
\paragraph{Dopaminerge Rezeptoren} % (fold)
...
\end{tabularx}
% paragraph dopaminerge_rezeptoren (end)
\paragraph{Dopaminerge Systeme} % (fold)
...
\end{tabularx}
% paragraph dopaminerge_systeme (end)
% subsection dopaminerge_synapse (end)
% section dopaminerges_system (end)
\section{Morbus Parkinson} % (fold)
...
\end{itemize}
% section morbus_parkinson (end)
\section{Extrapyramidales System / Basalganglien} % (fold)
\label{sec:extrapyramidales_system_basalganglien}
\subsection{Funktionskreis} % (fold)
\label{sub:funktionskreis}
\subsubsection{Thalamus – Cortex – Basalganglien} % (fold)
\label{ssub:subsubsection_name}
...
% subsubsection subsubsection_name (end) 
% subsubsection funktionskreis (end)
\subsection{Direkter Weg} % (fold)
\label{sub:ditekter_weg}
\subsubsection{Striatum $\rightarrow$ Globus pallidus med. $\rightarrow$ Thalamus } % (fold)
\label{ssub:subsubsection_name}
Aktivierung inhibiert Thalamus; über D2-Rezept. durch nigrostriatal. System inhibiert
% subsubsection subsubsection_name (end)
\subsubsection{Indirekter Weg: Striatum $\rightarrow$ Globus pallidus lat. $\rightarrow$ Ncl. Subthalam. $\rightarrow$ Thalamus} % (fold)
...
% subsubsection indirekter_weg_striatum_globus_pallidus_lat_ncl_subthalam_thalamus (end)
% subsection ditekter_weg (end)
\subsection{Bei M.Parkinson} % (fold)
...
% subsection bei_m_parkinson (end)
% section extrapyramidales_system_basalganglien (end)
\section{Therapie des Morbus Parkinson} % (fold)
\label{sec:therapie_des_morbus_parkinson}
\subsection{Erhöhung der striatalen Dopaminkonz. durch Gabe von L-Dopa 
  sowie d. Hemmung des Dopaminabbaus (MAO$_B$/COMT-Hemmer)} % (fold)
...
\subsubsection{Levodopa (L-Dopa)} % (fold)
...
% subsubsection levodopa_ (end)
\subsubsection{Dopa-Decarboxylase-Hemmer} % (fold)
...
\end{itemize}
% subsubsection dopa_decarboxylase_hemmer (end)
Wirkung von L-Dopa + DDC-Hemmer lässt nach 3-5 Jahren nach
\paragraph{Wirkungseinschränkung} % (fold)
\label{par:paragraph_name}
Kürzere Wirkdauer, Wirkungsausmaß d. Einzeldosis $\downarrow$  
\paragraph{Wirkungsfluktuation / on-off-Phänomen} % (fold)
\label{par:paragraph_name}
...
% paragraph paragraph_name (end): 
\paragraph{unerw. Wirkungen} % (fold)
\label{par:paragraph_name}
...
v.a. Patienten $>$ 70 J.
% paragraph einsatz (end)
\subsubsection{Monoaminoxidase B Hemmer} % (fold)
...
\end{itemize}
% subsubsection monoaminoxidase_b_hemmer (end)
\subsubsection{Catecho-O-Methyltransferase(COMT)-Hemmer} % (fold)
...
\end{itemize}
% subsubsection catecho_o_methyltransferase_ (end)
% subsection erh_hung_der_striatalen_dopaminkonz_durch_gabe_von_l_dopa_sowie_d_hemmung_des_dopaminabbaus_mao__b_comt_hemmer_ (end)
\subsection{Direkte Stimulation zentraler Dopaminrezeptoren} % (fold)
\label{sub:direkte_stimulation_zentraler_dopaminrezeptoren}
\subsubsection{Dopamin-Rezeptoragonisten} % (fold)
...
\end{itemize}
% subsubsection dopamin_rezeptoragonisten (end)
% subsection direkte_stimulation_zentraler_dopaminrezeptoren (end)
\subsection{Hemmung zentraler muscarinischer Rezeptoren} % (fold)
\label{sub:hemmung_zentraler_muscarinischer_rezeptoren}
\subsubsection{Muskarinrezeptor-Antagonisten} % (fold)
...
\begin{itemize}
	...
	\item[cave] Glaukom
\end{itemize}
% subsubsection muskarinrezeptor_antagonisten (end)
% subsection hemmung_zentraler_muscarinischer_rezeptoren (end)
\subsection{Blockade von Glutamat-Rezepotoren (NMDA-Typ)} % (fold)
\label{sub:blockade_von_glutamat_rezepotoren_}
\subsubsection{NMDA Rezeptor-Antagonisten} % (fold)
...
\end{itemize}
% subsubsection nmda_rezeptor_antagonisten (end)
% subsection blockade_von_glutamat_rezepotoren_ (end)
% section therapie_des_morbus_parkinson (end)
% chapter anti_parkinsonmittel (end)
\chapter{Antiepileptika} % (fold)
...
\section{Formen der Epilepsie} % (fold)
\label{sec:formen_der_epilepsie}
\subsection{Fokal} % (fold)
\label{sub:fokal}
...
\end{itemize}
% subsection fokal (end)
\subsection{Pimär generalisiert} % (fold)
...
\end{itemize}
% subsection pim_r_generalisiert (end)
\subsection{Nicht klassifizierbar} % (fold)
\label{sub:nicht_klassifizierbar}
$<$ 8\%
% subsection nicht_klassifizierbar (end)
% section formen_der_epilepsie (end)
\section{Pathomechanismen der Epilepsie} % (fold)
...
\end{itemize}
\subsection{Zelluläres Korrelat} % (fold)
...
% subsection zellul_res_korrelat (end)
\subsection{Versagen der Umfeldhemmung} % (fold)
...
% subsection versagen_der_umfeldhemmung (end)
% section pathomechanismen_der_epilepsie (end)
\section{Antiepileptika} % (fold)
\label{sec:antiepileptika}
zur symptomatischen Therapie bzw. Prophylaxe ($>$ 1 Anfall / Jahr)
\subsection{Hemmung der Erregbarkeit von Neuronen} % (fold)
...
% subsection hemmung_der_erregbarkeit_von_neuronen (end)
\subsection{Verstärkung der Umfeldhemmung epileptisch aktiver Neurone} % (fold)
...
% subsection verst_rkung_der_umfeldhemmung_epileptisch_aktiver_neurone (end)
\subsection{Pharmaka} % (fold)
\label{sub:pharmaka}
\subsubsection{Pheytoin} % (fold)
\label{ssub:pheytoin}
\begin{itemize}
...
\end{itemize}
% subsubsection pheytoin (end)
\subsubsection{Carbamazepin} % (fold)
...
\end{itemize}
% subsubsection carbamazepin (end)
\subsubsection{Lamotrigin} % (fold)
...
\end{itemize}
% subsubsection lamotrigin (end)
\subsubsection{Valproinsäure} % (fold)
...
\end{itemize}
% subsubsection valproins_ure (end)
\subsubsection{Ethosuximid} % (fold)
...
\end{itemize}
% subsubsection ethosuximid (end)
\subsubsection{Gabapentin} % (fold)
...
\end{itemize}
% subsubsection gabapentin (end)
\subsubsection{Levetiracetam} % (fold)
...
\end{itemize}
% subsubsection levetiracetam (end)
\subsubsection{Benzodiazepine} % (fold)
...
% subsubsection benzodiazepine (end)
\subsubsection{Phenobarbital, Primidon} % (fold)
...
\end{itemize}
% subsubsection phenobarbital_primidon (end)
\subsubsection{Vigabatrin} % (fold)
...
\end{itemize}
% subsubsection vigabatrin (end)
% subsection pharmaka (end)
\subsection{Antiepileptika - Indikationen} % (fold)
...
\end{tabularx}
% subsection antiepileptika_indikationen (end)
% section antiepileptika (end)
\section{Pharmakotherapie bei Status epilepticus} % (fold)
\label{sec:pharmakotherapie_bei_status_epilepticus}
\subsubsection{Diazepam} % (fold)
\label{ssub:diazepam}
i.v. oder rectal 
\begin{itemize}
	\item[Kinder] 5 mg
...
\end{itemize}
% subsubsection diazepam (end)
Zusätzlich bzw. wenn keine Besserung:	
\subsubsection{Phenytoin} % (fold)
...
\end{itemize}
% subsubsection phenytoin (end)
wenn keine Besserung: Phenobarbital bzw. Narkose
FDA-Warnung vor Suizidalität unter Antiepileptika (2008)
% section pharmakotherapie_bei_status_epilepticus (end)
% chapter antiepileptika (end)
\chapter{Antidepressiva} % (fold)
\label{cha:antidepressiva}
\section{Pharmakodynamik} % (fold)
...
\mbox{} \\
% section pharmakodynamik (end)
\begin{tabularx}{\textwidth}{lcccccccc}
& \multicolumn{2}{@{}l}{Transporterhemmung}&\multicolumn{5}{@{}c}{Rezeptorblockade}\\
...
Mirtazapin&-&-&+&+&+++&++++&+++\\
\end{tabularx}
\section{Nicht-selektive Monoamin-„Reuptake“-Inhibitoren (NSMRI)} % (fold)
...
\end{itemize}
% subsubsection interaktionen (end)
\subsubsection{akute Vergiftung} % (fold)
\label{ssub:akute_vergiftung}
...
% subsubsection akute_vergiftung (end)
% section nicht_selektive_monoamin_reuptake_inhibitoren_nsmri_ (end)
\section{Selektive Serotonin-„Reuptake“-Inhibitoren (SSRI)} % (fold)
...
% subsection akute_vergiftung (end)
\subsubsection{Wechselwirkungen} % (fold)
\label{ssub:wechselwirkungen}
cave: MAO-Hemmer !! 
...
% subsubsection wechselwirkungen (end)
% section selektive_serotonin_reuptake_inhibitoren_ssri_ (end)
\section{MAO-A-Hemer} % (fold)
...
\end{itemize}
% section mao_a_hemer (end)
\section{Pharmaka zur Phasenprophylaxe affektiver Psychosen bzw. Therapie einer Manie} % (fold)
\label{sec:pharmaka_zur_phasenprophylaxe_affektiver_psychosen_bzw_therapie_einer_manie}
\subsection{Lithium} % (fold)
\label{sub:lithium}
\subsubsection{Einsatz} % (fold)
\label{ssub:einsatz}
\begin{itemize}
...
% subsubsection kontraindikationen (end)
% subsection lithium (end)
% section pharmaka_zur_phasenprophylaxe_affektiver_psychosen_bzw_therapie_einer_manie (end)
% chapter antidepressiva (end)
\chapter{Neuroleptika} % (fold)
\label{cha:neuroleptika}
\section{"Klassiche" Neuroleptika} % (fold)
\label{sec:}
\begin{tabularx}{\textwidth}{lcc}
...
\end{tabularx}
% section  (end)
\section{Wirkmechanismen / Nebenwirkungen klassischer Neuroleptika} % (fold)
...
Benperidol&200\\	
\end{tabularx}
% section wirkmechanismen_nebenwirkungen_klassischer_neuroleptika (end)
\subsubsection{Pharmakokinetik} % (fold)
\label{ssub:pharmakokinetik}
\begin{itemize}
...
\end{itemize}
% subsubsection indikationen (end)
\subsubsection{Neuroleptikavergiftung} % (fold)
...
\begin{itemize}
	...
	\item Therapie: Giftentfernung
		...
		\end{itemize}	
\end{itemize}
% subsubsection neuroleptikavergiftung (end)
\section{"Atypische" Neuroleptika} % (fold)
\label{sec:section_name}
\subsection{Neuroleptika mit anderem Wirkprofil} % (fold)
...
% subsection neuroleptika_mit_anderem_wirkprofil (end)
\subsection{Antagonismus am Serotonien 5-HT$_{2A}$ Rezeptor} % (fold)
...
% subsection antagonismus_am_serotonien_5_ht__ (end)
\subsection{Nebenwirkungen} % (fold)
...
% subsection nebenwirkungen (end)
\subsection{Rezeptorprofil atyptischer Neuroleptika (Antagonismus)} % (fold)
...
Promazin&+&?&+&++&+++&+++\\
\end{tabularx}
% subsection rezeptorprofil_atyptischer_neuroleptika_ (end)
\begin{itemize}
	\item Clozapin\\
...
\end{itemize}
% section section_name (end)
% chapter neuroleptika (end)
\chapter{Magen-Darm-Pharmaka} % (fold)
\label{cha:magen_darm_pharmaka}
\section{Regulation der Magensaftsekretion} % (fold)
\label{sec:regulation_der_magensaftsekretion}
\subsubsection{Kephale Phase} % (fold)
...
\end{itemize}
% subsection kephale_phase (end)
\subsubsection{Gastrale Phase} % (fold)
...
\end{itemize}
% subsubsection gastrale_phase (end)
\subsubsection{Intestinale Phase} % (fold)
...
% subsubsection intestinale_phase (end)
\subsection{Regulation der H$^+$-Produktion im Magen} % (fold)
\label{sub:regulation_der_}

% subsection regulation_der_ (end)
% section regulation_der_magensaftsekretion (end)
\section{Antazida} % (fold)
\label{sec:antiazida}
\begin{tabularx}{\textwidth}{XX}
...
% subsubsection unerw_nschte_wirkungen (end)
\subsection{Schichtgitter Antazida} % (fold)
...
% paragraph einsatz (end)
% subsection schichtgitter_antazida (end)
% section antiazida (end)
\section{Protonenpumpenhemmer} % (fold)
...
\end{itemize}
% subsubsection einsatz (end)
% section protonenpumpenhemmer (end)
\section{H$_2$-Rezeptoragonisten} % (fold)
...
\end{itemize}
% subsubsection unerw_nschte_wirkung (end)
\subsubsection{Interaktionen} % (fold)
\label{ssub:interaktionen}
...
% subsubsection einsatz (end)
% section h__2_rezeptoragonisten (end)
\section{Eradikationsbehandlung bei Helicobacter pylori-assoziierten Ulzera} % (fold)
...
\multicolumn{2}{@{}c}{2 x täglich über 7 Tage}&&\multicolumn{2}{@{}c}{2 x täglich über 7 Tage}\\
\end{tabularx}
...
% section eradikationsbehandlung_bei_helicobacter_pylori_assoziierten_ulzera (end)
\section{Erbrechen} % (fold)
\label{sec:erbrechen}
\subsubsection{Auslösung des Brechreflexes} % (fold)
...
% subsubsection emetin (end)
\subsubsection{Apomorphin} % (fold)
...
% subsubsection apomorphin (end)
\subsubsection{Antiemetika} % (fold)
\label{ssub:antiemetika}
\paragraph{Dopamin D$_2$-Rezeptor-Antagonisten} % (fold)
...
\end{itemize}
% paragraph dopamin_d__2_rezeptor_antagonisten (end)
\paragraph{Histamin H$_1$-Rezeptor-Antagonisten} % (fold)
...
\end{itemize}
% paragraph histamin_h__1_rezeptor_antagonisten (end)
\paragraph{Muscarin-Rezeptor-Antagonisten} % (fold)
...
\begin{itemize}
	...
	Einsatz: Kinetosen
\end{itemize}
% paragraph muscarin_rezeptor_antagonisten (end)
\paragraph{Serotonin-(5-HT$_3$)-Rezeptor-Antagonisten} % (fold)
...
\begin{itemize}
	...
	\begin{itemize}
	 ...
	 \end{itemize} 
\end{itemize}
% paragraph serotonin_5_ht__3_rezeptor_antagonisten (end)
\paragraph{Substanz-P-(NK$_1$)-Rezeptor-Antagonisten } % (fold)
...
\end{itemize}
% paragraph substanz_p_nk__1_rezeptor_antagonisten_ (end)
\paragraph{Cannaboide} % (fold)
...
% paragraph cannaboide (end)
% subsubsection antiemetika (end)
% subsection emetika (end)
% section erbrechen (end)
\section{Prokinetika} % (fold)
...
&\multicolumn{3}{@{}c}{Agonism./Antagonism.}&\multicolumn{2}{@{}c}{Prokinet. Wirkung an}\\
...
% subsubsection einsatz (end)
% section prokinetika (end)
\section{Diarrhoe} % (fold)
\label{sec:diarrhoe}
$>$ 3 x täglich breiiger/wässriger Stuhlgang
\subsection{Ursachen} % (fold)
\label{sub:ursachen}
\begin{itemize}
...
\end{itemize}
% subsection ursachen (end)
\subsection{Therapie} % (fold)
\label{sub:therapie}
(Je nach zugrundeliegender Erkrankung)
\subsubsection{Flüssigkeits- und Elektrolytersatz} % (fold)
...
% subsubsection fl_ssigkeits_und_elektrolytersatz (end)
\subsubsection{Opiate / Enkephalinase-Hemmer} % (fold)
...
% subsubsection opiate_enkephalinase_hemmer (end)
\subsubsection{Antibiotika} % (fold)
\label{ssub:antibiotika}
bei schwerem Verlauf und system. Komplikationen, Verd. auf Infektion Co-trimoxazol; Ciprofloxacin
% subsubsection antibiotika (end)
% subsection therapie (end)
% section diarrhoe (end)
\section{Obstipation} % (fold)
...
\end{itemize}
\subsubsection{Strenge Indikationsstellung für Laxantien!} % (fold)
...
% subsubsection strenge_indikationsstellung_f_r_laxantien_ (end)
% subsection ursachen (end)
\subsection{Therapie} % (fold)
\label{sub:therapie}
\subsubsection{Quell- und Ballaststoffe, Gleitmittel} % (fold)
...
% subsubsection quell_und_ballaststoffe_gleitmittel (end)
\subsubsection{Osmotisch wirksame Laxantien} % (fold)
...
\end{tabularx}
% subsubsection osmotisch_wirksame_laxantien (end)
\subsubsection{Stimulierende Laxantien} % (fold)
...
\end{tabularx}
% subsubsection stimulierende_laxantien (end)
% subsection therapie (end)
% section obstipation (end)
% chapter magen_darm_pharmaka (end)
\end{document}